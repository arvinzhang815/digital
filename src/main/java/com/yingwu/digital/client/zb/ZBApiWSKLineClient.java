...
import com.yingwu.digital.client.okex.AbsOKExApiWSClient;
...
public class ZBApiWSKLineClient extends AbsOKExApiWSClient<OKExKLineResponse> {
    ...
    public ZBApiWSKLineClient(OKExApiWSClientImpl client, OKExWSEventHandler handler, String symbol, String period) {
