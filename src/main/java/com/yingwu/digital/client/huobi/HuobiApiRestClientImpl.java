...
public class HuobiApiRestClientImpl implements HuobiApiRestClienttt {
    ...
    private DigitalApiError parseError(HuobiResp resp) {
        if (resp.getStatus().equals("ok")) {
            return null;
        }
        DigitalApiError err = new DigitalApiError();
    ...
    public List<HuobiKLineData> kline(String symbol, String period, int size) throws DigitalException {
        ...
        HuobiKLineResp resp = httpGet(DigitalConst.MARKET_URL, path, map, HuobiKLineResp.class);
        return resp.getData();
    }
    ...
    public HuobiTick tick(String symbol) throws DigitalException {
        ...
        Map<String, String> map = new HashMap<>();
        map.put("symbol", symbol.toLowerCase());
        HuobiTickResp resp = httpGet(DigitalConst.MARKET_URL, path, map, HuobiTickResp.class);
        return resp.getTick();
    }
    ...
    public HuobiOrderBook depth(String symbol, String type) throws DigitalException {
        ...
        query.put("type", type);
        HuobiOrderBookResp resp = httpGet(DigitalConst.MARKET_URL, path, query, HuobiOrderBookResp.class);
    ...
    public List<HuobiAccount> accounts() throws DigitalException {
        ...
        HuobiAccountResp resp = httpGet(DigitalConst.TRADE_URL, path, query, HuobiAccountResp.class);
    ...
    public HuobiBalance balance(long accountId) throws DigitalException {
        ...
        HuobiBalanceResp resp = httpGet(DigitalConst.TRADE_URL, path, query, HuobiBalanceResp.class);
        return resp.data;
    }
    ...
    public String sendOrder(String symbol, String price, String amount, HuobiOrderType type) throws DigitalException {
        ...
        HuobiOrderResp resp = httpPost(DigitalConst.TRADE_URL, path, query, map, HuobiOrderResp.class);
    ...
    public String cancelOrder(String orderId) throws DigitalException {
        ...
        HashMap<String, String> map = new HashMap<>();
        Map<String, String> query = buildQueryMap(map, METHOD_POST, path);
        HuobiCancelOrderResp resp = httpPost(DigitalConst.TRADE_URL, path, query, map, HuobiCancelOrderResp.class);
        return resp.getOrderId();
    }
    ...
    public HuobiOrderInfo orderInfo(String orderId) throws DigitalException {
        ...
        HashMap<String, String> map = new HashMap<>();
        Map<String, String> query = buildQueryMap(map, METHOD_GET, path);
        HuobiOrderInfolResp resp = httpGet(DigitalConst.TRADE_URL, path, query, HuobiOrderInfolResp.class);
    ...
    public HuobiOrderMatchResult matchResult(String orderId) throws DigitalException {
        ...
        HashMap<String, String> map = new HashMap<>();
        Map<String, String> query = buildQueryMap(map, METHOD_GET, path);
        HuobiOrderMatchResultResp resp = httpGet(DigitalConst.TRADE_URL, path, query, HuobiOrderMatchResultResp.class);
    ...
    public List<HuobiOrderInfo> orders(String symbol,
        ...
        Map<String, String> query = buildQueryMap(map, METHOD_GET, path);
        HuobiOrdersResp resp = httpGet(DigitalConst.TRADE_URL, path, query, HuobiOrdersResp.class);
