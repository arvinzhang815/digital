...
public class OKExApiWSKLineClient extends AbsOKExApiWSClient<HuobiWSKLineResp> {
    ...
    public OKExApiWSKLineClient(HuobiApiWSClientImpl client, HuobiWSEventHandler handler, String symbol, String period) {
