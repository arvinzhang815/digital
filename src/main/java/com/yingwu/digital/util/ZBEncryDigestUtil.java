...
public class ZBEncryDigestUtil {

	private static String encodingCharset = "UTF-8";
	
	
	public static String hmacSign(Map aValue, String aKey) {
		String  value = toStringMap(aValue);
		return hmacSign(value, aKey , "MD5");
	}
	...
	public static String getHmac(String[] args, String key) {
		...
		return (hmacSign(str.toString(), key,"MD5"));
	}
